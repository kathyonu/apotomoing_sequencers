...
### uncomment this puts below, for use in console to show when it is loaded. do not use in development, nor production
...
#   foo.gsub(/[Á]/, "c")                 # foreign character replacement
   foo.gsub!(/(\$\s?(24,?000,?000\.?00))|(\$\s?(25,?000,?000))/, " twenty four million dollars ")  
    ...
    foo.gsub!(/(\$\s?(4,?000,?000\.?00))|(\$\s?(4,?000,?000))/, " fourmillion dollars ")
