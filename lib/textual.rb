...
#   foo.gsub(/[Á]/, "c")                 # foreign character replacement
    ...
    foo.gsub!(/(\$4,?000\.?)0?0?/, " four thousand dollars ")
   ...
   #foo.gsub!(/(\s(1000(['']?)s)\s+?)/, " thousands ")       # with all the ' still existing
    ...
    foo.gsub!(/\s9999$/, " ninety nine ninety nine ")
    foo.gsub!(/\s8888$/, " eighty eight eighty eight ")
    foo.gsub!(/\s7777$/, " seventy seven seventy seven ")
    foo.gsub!(/\s6666$/, " sixty six sixty six ")
    foo.gsub!(/\s5555$/, " fifty five fifty five  ")
    foo.gsub!(/\s4444$/, " forty four forty four  ")
    foo.gsub!(/\s3333$/, " thirty three thirty three ")
    foo.gsub!(/\s2222$/, " twenty two twenty two ")
    foo.gsub!(/\s2121$/, " twenty one twenty one ")
    foo.gsub!(/\s1212$/, " twelve twelve ")
    foo.gsub!(/\s1111$/, " eleven eleven ")
    foo.gsub!(/\s1010$/, " ten ten ")

    foo.gsub!(/(\s6900\s)/, " sixty nine hundred ")
    foo.gsub!(/(^6900\s)/, " sixty nine hundred ")
    foo.gsub!(/(\s6900$)/, " sixty nine hundred ")
    ...
    foo.gsub!(/3,?211/, " three thousand two hundred eleven ")
    ...
    foo.gsub!(/\s+(113th,)/, " one hundred and thirteenth, ")
    foo.gsub!(/\s+(112th,)/, " one hundred and twelfth, ")
    foo.gsub!(/\s+(111th,)/, " one hundred and eleventh, ")
    ...
    foo.gsub!(/\s+(\$9\.99\s?)/, " nine dollars ninety nine cents ")
    foo.gsub!(/\s+(09:50)/, " nine fifty ")
    foo.gsub!(/\s+(09:49)/, " nine forty nine ")
    foo.gsub!(/\s+(09:48)/, " nine forty eight ")
    foo.gsub!(/\s+(09:47)/, " nine forty seven ")
    foo.gsub!(/\s+(09:46)/, " nine forty six ")
    foo.gsub!(/\s+(09:45)/, " nine forty five ")
    foo.gsub!(/\s+(09:44)/, " nine forty four ")
    foo.gsub!(/\s+(09:43)/, " nine forty three ")
    foo.gsub!(/\s+(09:42)/, " nine forty two ")
    foo.gsub!(/\s+(09:41)/, " nine forty one ")
    foo.gsub!(/\s+(09:40)/, " nine forty ")
    foo.gsub!(/\s+(09:39)/, " nine thirty nine ")
    foo.gsub!(/\s+(09:38)/, " nine thirty eight ")
    foo.gsub!(/\s+(09:37)/, " nine thirty seven ")
    foo.gsub!(/\s+(09:36)/, " nine thirty six ")
    foo.gsub!(/\s+(09:35)/, " nine thirty five ")
    foo.gsub!(/\s+(09:34)/, " nine thirty four ")
    foo.gsub!(/\s+(09:33)/, " nine thirty three ")
    foo.gsub!(/\s+(09:32)/, " nine thirty two ")
    foo.gsub!(/\s+(09:31)/, " nine thirty one ")
    foo.gsub!(/\s+(09:30)/, " nine thirty ")
    foo.gsub!(/\s+(09:29)/, " nine twenty nine ")
    foo.gsub!(/\s+(09:28)/, " nine twenty eight ")
    foo.gsub!(/\s+(09:27)/, " nine twenty seven ")
    foo.gsub!(/\s+(09:26)/, " nine twenty six ")
    foo.gsub!(/\s+(09:25)/, " nine twenty five ")
    foo.gsub!(/\s+(09:24)/, " nine twenty four ")
    foo.gsub!(/\s+(09:23)/, " nine twenty three ")
    foo.gsub!(/\s+(09:22)/, " nine twenty two ")
    foo.gsub!(/\s+(09:21)/, " nine twenty one ")
    foo.gsub!(/\s+(09:20)/, " nine twenty ")
    foo.gsub!(/\s+(09:19)/, " nine nineteen ")
    foo.gsub!(/\s+(09:18)/, " nine eighteen ")
    foo.gsub!(/\s+(09:17)/, " nine seventeen ")
    foo.gsub!(/\s+(09:16)/, " nine sixteen ")
    foo.gsub!(/\s+(09:15)/, " nine fifteen ")
    foo.gsub!(/\s+(09:14)/, " nine fourteen ")
    foo.gsub!(/\s+(09:13)/, " nine thirteen ")
    foo.gsub!(/\s+(09:12)/, " nine twelve ")
    foo.gsub!(/\s+(09:11)/, " nine eleven ")
    foo.gsub!(/\s+(09:14)/, " nine fourteen ")
    foo.gsub!(/\s+(09:13)/, " nine thirteen ")
    foo.gsub!(/\s+(09:12)/, " nine twelve ")
    foo.gsub!(/\s+(09:11)/, " nine eleven ")
    foo.gsub!(/\s+(09:10)/, " nine ten ")
    foo.gsub!(/\s+(09:09)/, " nine o nine ")
    foo.gsub!(/\s+(09:08)/, " nine o eight ")
    foo.gsub!(/\s+(09:07)/, " nine o seven ")
    foo.gsub!(/\s+(09:06)/, " nine o six ")
    foo.gsub!(/\s+(09:05)/, " nine o five ")
    foo.gsub!(/\s+(09:04)/, " nine o four ")
    foo.gsub!(/\s+(09:03)/, " nine o three ")
    foo.gsub!(/\s+(09:02)/, " nine o two ")
    foo.gsub!(/\s+(09:01)/, " nine o one ")
    foo.gsub!(/\s+(09:00)/, " nine ")
    foo.gsub!(/\s+(08:59)/, " eight fifty nine ")
    foo.gsub!(/\s+(08:58)/, " eight fifty eight ")
    foo.gsub!(/\s+(08:57)/, " eight fifty seven ")
    foo.gsub!(/\s+(08:56)/, " eight fifty six ")
    foo.gsub!(/\s+(08:55)/, " eight fifty five ")
    foo.gsub!(/\s+(08:54)/, " eight fifty four ")
    foo.gsub!(/\s+(08:53)/, " eight fifty three ")
    foo.gsub!(/\s+(08:52)/, " eight fifty two ")
    foo.gsub!(/\s+(08:51)/, " eight fifty one ")
    foo.gsub!(/\s+(08:50)/, " eight fifty ")
    foo.gsub!(/\s+(08:49)/, " eight forty nine ")
    foo.gsub!(/\s+(08:48)/, " eight forty eight ")
    foo.gsub!(/\s+(08:47)/, " eight forty seven ")
    foo.gsub!(/\s+(08:46)/, " eight forty six ")
    foo.gsub!(/\s+(08:45)/, " eight forty five ")
    foo.gsub!(/\s+(08:44)/, " eight forty four ")
    foo.gsub!(/\s+(08:43)/, " eight forty three ")
    foo.gsub!(/\s+(08:42)/, " eight forty two ")
    foo.gsub!(/\s+(08:41)/, " eight forty one ")
    foo.gsub!(/\s+(08:40)/, " eight forty ")
    foo.gsub!(/\s+(08:39)/, " eight thirty nine ")
    foo.gsub!(/\s+(08:38)/, " eight thirty eight ")
    foo.gsub!(/\s+(08:37)/, " eight thirty seven ")
    foo.gsub!(/\s+(08:36)/, " eight thirty six ")
    foo.gsub!(/\s+(08:35)/, " eight thirty five ")
    foo.gsub!(/\s+(08:34)/, " eight thirty four ")
    foo.gsub!(/\s+(08:33)/, " eight thirty three ")
    foo.gsub!(/\s+(08:32)/, " eight thirty two ")
    foo.gsub!(/\s+(08:31)/, " eight thirty one ")
    foo.gsub!(/\s+(08:30)/, " eight thirty ")
    foo.gsub!(/\s+(08:29)/, " eight twenty nine ")
    foo.gsub!(/\s+(08:28)/, " eight twenty eight ")
    foo.gsub!(/\s+(08:27)/, " eight twenty seven ")
    foo.gsub!(/\s+(08:26)/, " eight twenty six ")
    foo.gsub!(/\s+(08:25)/, " eight twenty five ")
    foo.gsub!(/\s+(08:24)/, " eight twenty four ")
    foo.gsub!(/\s+(08:23)/, " eight twenty three ")
    foo.gsub!(/\s+(08:22)/, " eight twenty two ")
    foo.gsub!(/\s+(08:21)/, " eight twenty one ")
    foo.gsub!(/\s+(08:20)/, " eight twenty ")
    foo.gsub!(/\s+(08:19)/, " eight nineteen ")
    foo.gsub!(/\s+(08:18)/, " eight eighteen ")
    foo.gsub!(/\s+(08:17)/, " eight seventeen ")
    foo.gsub!(/\s+(08:16)/, " eight sixteen ")
    foo.gsub!(/\s+(08:15)/, " eight fifteen ")
    foo.gsub!(/\s+(08:14)/, " eight fourteen ")
    foo.gsub!(/\s+(08:13)/, " eight thirteen ")
    foo.gsub!(/\s+(08:12)/, " eight twelve ")
    foo.gsub!(/\s+(08:11)/, " eight eleven ")
    foo.gsub!(/\s+(08:14)/, " eight fourteen ")
    foo.gsub!(/\s+(08:13)/, " eight thirteen ")
    foo.gsub!(/\s+(08:12)/, " eight twelve ")
    foo.gsub!(/\s+(08:11)/, " eight eleven ")
    foo.gsub!(/\s+(08:10)/, " eight ten ")
    foo.gsub!(/\s+(08:09)/, " eight o nine ")
    foo.gsub!(/\s+(08:08)/, " eight o eight ")
    foo.gsub!(/\s+(08:07)/, " eight o seven ")
    foo.gsub!(/\s+(08:06)/, " eight o six ")
    foo.gsub!(/\s+(08:05)/, " eight o five ")
    foo.gsub!(/\s+(08:04)/, " eight o four ")
    foo.gsub!(/\s+(08:03)/, " eight o three ")
    foo.gsub!(/\s+(08:02)/, " eight o two ")
    foo.gsub!(/\s+(08:01)/, " eight o one ")
    foo.gsub!(/\s+(08:00)/, " eight ")
    foo.gsub!(/\s+(07:50)/, " seven fifty ")
    foo.gsub!(/\s+(07:49)/, " seven forty nine ")
    foo.gsub!(/\s+(07:48)/, " seven forty eight ")
    foo.gsub!(/\s+(07:47)/, " seven forty seven ")
    foo.gsub!(/\s+(07:46)/, " seven forty six ")
    foo.gsub!(/\s+(07:45)/, " seven forty five ")
    foo.gsub!(/\s+(07:44)/, " seven forty four ")
    foo.gsub!(/\s+(07:43)/, " seven forty three ")
    foo.gsub!(/\s+(07:42)/, " seven forty two ")
    foo.gsub!(/\s+(07:41)/, " seven forty one ")
    foo.gsub!(/\s+(07:40)/, " seven forty ")
    foo.gsub!(/\s+(07:39)/, " seven thirty nine ")
    foo.gsub!(/\s+(07:38)/, " seven thirty eight ")
    foo.gsub!(/\s+(07:37)/, " seven thirty seven ")
    foo.gsub!(/\s+(07:36)/, " seven thirty six ")
    foo.gsub!(/\s+(07:35)/, " seven thirty five ")
    foo.gsub!(/\s+(07:34)/, " seven thirty four ")
    foo.gsub!(/\s+(07:33)/, " seven thirty three ")
    foo.gsub!(/\s+(07:32)/, " seven thirty two ")
    foo.gsub!(/\s+(07:31)/, " seven thirty one ")
    foo.gsub!(/\s+(07:30)/, " seven thirty ")
    foo.gsub!(/\s+(07:29)/, " seven twenty nine ")
    foo.gsub!(/\s+(07:28)/, " seven twenty eight ")
    foo.gsub!(/\s+(07:27)/, " seven twenty seven ")
    foo.gsub!(/\s+(07:26)/, " seven twenty six ")
    foo.gsub!(/\s+(07:25)/, " seven twenty five ")
    foo.gsub!(/\s+(07:24)/, " seven twenty four ")
    foo.gsub!(/\s+(07:23)/, " seven twenty three ")
    foo.gsub!(/\s+(07:22)/, " seven twenty two ")
    foo.gsub!(/\s+(07:21)/, " seven twenty one ")
    foo.gsub!(/\s+(07:20)/, " seven twenty ")
    foo.gsub!(/\s+(07:19)/, " seven nineteen ")
    foo.gsub!(/\s+(07:18)/, " seven eighteen ")
    foo.gsub!(/\s+(07:17)/, " seven seventeen ")
    foo.gsub!(/\s+(07:16)/, " seven sixteen ")
    foo.gsub!(/\s+(07:15)/, " seven fifteen ")
    foo.gsub!(/\s+(07:14)/, " seven fourteen ")
    foo.gsub!(/\s+(07:13)/, " seven thirteen ")
    foo.gsub!(/\s+(07:12)/, " seven twelve ")
    foo.gsub!(/\s+(07:11)/, " seven eleven ")
    foo.gsub!(/\s+(07:14)/, " seven fourteen ")
    foo.gsub!(/\s+(07:13)/, " seven thirteen ")
    foo.gsub!(/\s+(07:12)/, " seven twelve ")
    foo.gsub!(/\s+(07:11)/, " seven eleven ")
    foo.gsub!(/\s+(07:10)/, " seven ten ")
    foo.gsub!(/\s+(07:09)/, " seven o nine ")
    foo.gsub!(/\s+(07:08)/, " seven o eight ")
    foo.gsub!(/\s+(07:07)/, " seven o seven ")
    foo.gsub!(/\s+(07:06)/, " seven o six ")
    foo.gsub!(/\s+(07:05)/, " seven o five ")
    foo.gsub!(/\s+(07:04)/, " seven o four ")
    foo.gsub!(/\s+(07:03)/, " seven o three ")
    foo.gsub!(/\s+(07:02)/, " seven o two ")
    foo.gsub!(/\s+(07:01)/, " seven o one ")
    foo.gsub!(/\s+(07:00)/, " seven ")
    foo.gsub!(/\s+(06:50)/, " six fifty ")
    foo.gsub!(/\s+(06:49)/, " six forty nine ")
    foo.gsub!(/\s+(06:48)/, " six forty eight ")
    foo.gsub!(/\s+(06:47)/, " six forty seven ")
    foo.gsub!(/\s+(06:46)/, " six forty six ")
    foo.gsub!(/\s+(06:45)/, " six forty five ")
    foo.gsub!(/\s+(06:44)/, " six forty four ")
    foo.gsub!(/\s+(06:43)/, " six forty three ")
    foo.gsub!(/\s+(06:42)/, " six forty two ")
    foo.gsub!(/\s+(06:41)/, " six forty one ")
    foo.gsub!(/\s+(06:40)/, " six forty ")
    foo.gsub!(/\s+(06:39)/, " six thirty nine ")
    foo.gsub!(/\s+(06:38)/, " six thirty eight ")
    foo.gsub!(/\s+(06:37)/, " six thirty seven ")
    foo.gsub!(/\s+(06:36)/, " six thirty six ")
    foo.gsub!(/\s+(06:35)/, " six thirty five ")
    foo.gsub!(/\s+(06:34)/, " six thirty four ")
    foo.gsub!(/\s+(06:33)/, " six thirty three ")
    foo.gsub!(/\s+(06:32)/, " six thirty two ")
    foo.gsub!(/\s+(06:31)/, " six thirty one ")
    foo.gsub!(/\s+(06:30)/, " six thirty ")
    foo.gsub!(/\s+(06:29)/, " six twenty nine ")
    foo.gsub!(/\s+(06:28)/, " six twenty eight ")
    foo.gsub!(/\s+(06:27)/, " six twenty seven ")
    foo.gsub!(/\s+(06:26)/, " six twenty six ")
    foo.gsub!(/\s+(06:25)/, " six twenty five ")
    foo.gsub!(/\s+(06:24)/, " six twenty four ")
    foo.gsub!(/\s+(06:23)/, " six twenty three ")
    foo.gsub!(/\s+(06:22)/, " six twenty two ")
    foo.gsub!(/\s+(06:21)/, " six twenty one ")
    foo.gsub!(/\s+(06:20)/, " six twenty ")
    foo.gsub!(/\s+(06:19)/, " six nineteen ")
    foo.gsub!(/\s+(06:18)/, " six eighteen ")
    foo.gsub!(/\s+(06:17)/, " six seventeen ")
    foo.gsub!(/\s+(06:16)/, " six sixteen ")
    foo.gsub!(/\s+(06:15)/, " six fifteen ")
    foo.gsub!(/\s+(06:14)/, " six fourteen ")
    foo.gsub!(/\s+(06:13)/, " six thirteen ")
    foo.gsub!(/\s+(06:12)/, " six twelve ")
    foo.gsub!(/\s+(06:11)/, " six eleven ")
    foo.gsub!(/\s+(06:14)/, " six fourteen ")
    foo.gsub!(/\s+(06:13)/, " six thirteen ")
    foo.gsub!(/\s+(06:12)/, " six twelve ")
    foo.gsub!(/\s+(06:11)/, " six eleven ")
    foo.gsub!(/\s+(06:10)/, " six ten ")
    foo.gsub!(/\s+(06:09)/, " six o nine ")
    foo.gsub!(/\s+(06:08)/, " six o eight ")
    foo.gsub!(/\s+(06:07)/, " six o seven ")
    foo.gsub!(/\s+(06:06)/, " six o six ")
    foo.gsub!(/\s+(06:05)/, " six o five ")
    foo.gsub!(/\s+(06:04)/, " six o four ")
    foo.gsub!(/\s+(06:03)/, " six o three ")
    foo.gsub!(/\s+(06:02)/, " six o two ")
    foo.gsub!(/\s+(06:01)/, " six o one ")
    foo.gsub!(/\s+(06:00)/, " six ")
    foo.gsub!(/\s+(05:50)/, " five fifty ")
    foo.gsub!(/\s+(05:49)/, " five forty nine ")
    foo.gsub!(/\s+(05:48)/, " five forty eight ")
    foo.gsub!(/\s+(05:47)/, " five forty seven ")
    foo.gsub!(/\s+(05:46)/, " five forty six ")
    foo.gsub!(/\s+(05:45)/, " five forty five ")
    foo.gsub!(/\s+(05:44)/, " five forty four ")
    foo.gsub!(/\s+(05:43)/, " five forty three ")
    foo.gsub!(/\s+(05:42)/, " five forty two ")
    foo.gsub!(/\s+(05:41)/, " five forty one ")
    foo.gsub!(/\s+(05:40)/, " five forty ")
    foo.gsub!(/\s+(05:39)/, " five thirty nine ")
    foo.gsub!(/\s+(05:38)/, " five thirty eight ")
    foo.gsub!(/\s+(05:37)/, " five thirty seven ")
    foo.gsub!(/\s+(05:36)/, " five thirty six ")
    foo.gsub!(/\s+(05:35)/, " five thirty five ")
    foo.gsub!(/\s+(05:34)/, " five thirty four ")
    foo.gsub!(/\s+(05:33)/, " five thirty three ")
    foo.gsub!(/\s+(05:32)/, " five thirty two ")
    foo.gsub!(/\s+(05:31)/, " five thirty one ")
    foo.gsub!(/\s+(05:30)/, " five thirty ")
    foo.gsub!(/\s+(05:29)/, " five twenty nine ")
    foo.gsub!(/\s+(05:28)/, " five twenty eight ")
    foo.gsub!(/\s+(05:27)/, " five twenty seven ")
    foo.gsub!(/\s+(05:26)/, " five twenty six ")
    foo.gsub!(/\s+(05:25)/, " five twenty five ")
    foo.gsub!(/\s+(05:24)/, " five twenty four ")
    foo.gsub!(/\s+(05:23)/, " five twenty three ")
    foo.gsub!(/\s+(05:22)/, " five twenty two ")
    foo.gsub!(/\s+(05:21)/, " five twenty one ")
    foo.gsub!(/\s+(05:20)/, " five twenty ")
    foo.gsub!(/\s+(05:19)/, " five nineteen ")
    foo.gsub!(/\s+(05:18)/, " five eighteen ")
    foo.gsub!(/\s+(05:17)/, " five seventeen ")
    foo.gsub!(/\s+(05:16)/, " five sixteen ")
    foo.gsub!(/\s+(05:15)/, " five fifteen ")
    foo.gsub!(/\s+(05:14)/, " five fourteen ")
    foo.gsub!(/\s+(05:13)/, " five thirteen ")
    foo.gsub!(/\s+(05:12)/, " five twelve ")
    foo.gsub!(/\s+(05:11)/, " five eleven ")
    foo.gsub!(/\s+(05:14)/, " five fourteen ")
    foo.gsub!(/\s+(05:13)/, " five thirteen ")
    foo.gsub!(/\s+(05:12)/, " five twelve ")
    foo.gsub!(/\s+(05:11)/, " five eleven ")
    foo.gsub!(/\s+(05:10)/, " five ten ")
    foo.gsub!(/\s+(05:09)/, " five o nine ")
    foo.gsub!(/\s+(05:08)/, " five o eight ")
    foo.gsub!(/\s+(05:07)/, " five o seven ")
    foo.gsub!(/\s+(05:06)/, " five o six ")
    foo.gsub!(/\s+(05:05)/, " five o five ")
    foo.gsub!(/\s+(05:04)/, " five o four ")
    foo.gsub!(/\s+(05:03)/, " five o three ")
    foo.gsub!(/\s+(05:02)/, " five o two ")
    foo.gsub!(/\s+(05:01)/, " five o one ")
    foo.gsub!(/\s+(05:00)/, " five ")
    foo.gsub!(/\s+(04:50)/, " four fifty ")
    foo.gsub!(/\s+(04:49)/, " four forty nine ")
    foo.gsub!(/\s+(04:48)/, " four forty eight ")
    foo.gsub!(/\s+(04:47)/, " four forty seven ")
    foo.gsub!(/\s+(04:46)/, " four forty six ")
    foo.gsub!(/\s+(04:45)/, " four forty five ")
    foo.gsub!(/\s+(04:44)/, " four forty four ")
    foo.gsub!(/\s+(04:43)/, " four forty three ")
    foo.gsub!(/\s+(04:42)/, " four forty two ")
    foo.gsub!(/\s+(04:41)/, " four forty one ")
    foo.gsub!(/\s+(04:40)/, " four forty ")
    foo.gsub!(/\s+(04:39)/, " four thirty nine ")
    foo.gsub!(/\s+(04:38)/, " four thirty eight ")
    foo.gsub!(/\s+(04:37)/, " four thirty seven ")
    foo.gsub!(/\s+(04:36)/, " four thirty six ")
    foo.gsub!(/\s+(04:35)/, " four thirty five ")
    foo.gsub!(/\s+(04:34)/, " four thirty four ")
    foo.gsub!(/\s+(04:33)/, " four thirty three ")
    foo.gsub!(/\s+(04:32)/, " four thirty two ")
    foo.gsub!(/\s+(04:31)/, " four thirty one ")
    foo.gsub!(/\s+(04:30)/, " four thirty ")
    foo.gsub!(/\s+(04:29)/, " four twenty nine ")
    foo.gsub!(/\s+(04:28)/, " four twenty eight ")
    foo.gsub!(/\s+(04:27)/, " four twenty seven ")
    foo.gsub!(/\s+(04:26)/, " four twenty six ")
    foo.gsub!(/\s+(04:25)/, " four twenty five ")
    foo.gsub!(/\s+(04:24)/, " four twenty four ")
    foo.gsub!(/\s+(04:23)/, " four twenty three ")
    foo.gsub!(/\s+(04:22)/, " four twenty two ")
    foo.gsub!(/\s+(04:21)/, " four twenty one ")
    foo.gsub!(/\s+(04:20)/, " four twenty ")
    foo.gsub!(/\s+(04:19)/, " four nineteen ")
    foo.gsub!(/\s+(04:18)/, " four eighteen ")
    foo.gsub!(/\s+(04:17)/, " four seventeen ")
    foo.gsub!(/\s+(04:16)/, " four sixteen ")
    foo.gsub!(/\s+(04:15)/, " four fifteen ")
    foo.gsub!(/\s+(04:14)/, " four fourteen ")
    foo.gsub!(/\s+(04:13)/, " four thirteen ")
    foo.gsub!(/\s+(04:12)/, " four twelve ")
    foo.gsub!(/\s+(04:11)/, " four eleven ")
    foo.gsub!(/\s+(04:14)/, " four fourteen ")
    foo.gsub!(/\s+(04:13)/, " four thirteen ")
    foo.gsub!(/\s+(04:12)/, " four twelve ")
    foo.gsub!(/\s+(04:11)/, " four eleven ")
    foo.gsub!(/\s+(04:10)/, " four ten ")
    foo.gsub!(/\s+(04:09)/, " four o nine ")
    foo.gsub!(/\s+(04:08)/, " four o eight ")
    foo.gsub!(/\s+(04:07)/, " four o seven ")
    foo.gsub!(/\s+(04:06)/, " four o six ")
    foo.gsub!(/\s+(04:05)/, " four o five ")
    foo.gsub!(/\s+(04:04)/, " four o four ")
    foo.gsub!(/\s+(04:03)/, " four o three ")
    foo.gsub!(/\s+(04:02)/, " four o two ")
    foo.gsub!(/\s+(04:01)/, " four o one ")
    foo.gsub!(/\s+(04:00)/, " four ")
    foo.gsub!(/\s+(03:50)/, " three fifty ")
    foo.gsub!(/\s+(03:49)/, " three forty nine ")
    foo.gsub!(/\s+(03:48)/, " three forty eight ")
    foo.gsub!(/\s+(03:47)/, " three forty seven ")
    foo.gsub!(/\s+(03:46)/, " three forty six ")
    foo.gsub!(/\s+(03:45)/, " three forty five ")
    foo.gsub!(/\s+(03:44)/, " three forty four ")
    foo.gsub!(/\s+(03:43)/, " three forty three ")
    foo.gsub!(/\s+(03:42)/, " three forty two ")
    foo.gsub!(/\s+(03:41)/, " three forty one ")
    foo.gsub!(/\s+(03:40)/, " three forty ")
    foo.gsub!(/\s+(03:39)/, " three thirty nine ")
    foo.gsub!(/\s+(03:38)/, " three thirty eight ")
    foo.gsub!(/\s+(03:37)/, " three thirty seven ")
    foo.gsub!(/\s+(03:36)/, " three thirty six ")
    foo.gsub!(/\s+(03:35)/, " three thirty five ")
    foo.gsub!(/\s+(03:34)/, " three thirty four ")
    foo.gsub!(/\s+(03:33)/, " three thirty three ")
    foo.gsub!(/\s+(03:32)/, " three thirty two ")
    foo.gsub!(/\s+(03:31)/, " three thirty one ")
    foo.gsub!(/\s+(03:30)/, " three thirty ")
    foo.gsub!(/\s+(03:29)/, " three twenty nine ")
    foo.gsub!(/\s+(03:28)/, " three twenty eight ")
    foo.gsub!(/\s+(03:27)/, " three twenty seven ")
    foo.gsub!(/\s+(03:26)/, " three twenty six ")
    foo.gsub!(/\s+(03:25)/, " three twenty five ")
    foo.gsub!(/\s+(03:24)/, " three twenty four ")
    foo.gsub!(/\s+(03:23)/, " three twenty three ")
    foo.gsub!(/\s+(03:22)/, " three twenty two ")
    foo.gsub!(/\s+(03:21)/, " three twenty one ")
    foo.gsub!(/\s+(03:20)/, " three twenty ")
    foo.gsub!(/\s+(03:19)/, " three nineteen ")
    foo.gsub!(/\s+(03:18)/, " three eighteen ")
    foo.gsub!(/\s+(03:17)/, " three seventeen ")
    foo.gsub!(/\s+(03:16)/, " three sixteen ")
    foo.gsub!(/\s+(03:15)/, " three fifteen ")
    foo.gsub!(/\s+(03:14)/, " three fourteen ")
    foo.gsub!(/\s+(03:13)/, " three thirteen ")
    foo.gsub!(/\s+(03:12)/, " three twelve ")
    foo.gsub!(/\s+(03:11)/, " three eleven ")
    foo.gsub!(/\s+(03:14)/, " three fourteen ")
    foo.gsub!(/\s+(03:13)/, " three thirteen ")
    foo.gsub!(/\s+(03:12)/, " three twelve ")
    foo.gsub!(/\s+(03:11)/, " three eleven ")
    foo.gsub!(/\s+(03:10)/, " three ten ")
    foo.gsub!(/\s+(03:09)/, " three o nine ")
    foo.gsub!(/\s+(03:08)/, " three o eight ")
    foo.gsub!(/\s+(03:07)/, " three o seven ")
    foo.gsub!(/\s+(03:06)/, " three o six ")
    foo.gsub!(/\s+(03:05)/, " three o five ")
    foo.gsub!(/\s+(03:04)/, " three o four ")
    foo.gsub!(/\s+(03:03)/, " three o three ")
    foo.gsub!(/\s+(03:02)/, " three o two ")
    foo.gsub!(/\s+(03:01)/, " three o one ")
    foo.gsub!(/\s+(03:00)/, " three ")
    foo.gsub!(/\s+(02:59)/, " two fifty nine ")
    foo.gsub!(/\s+(02:58)/, " two fifty eight ")
    foo.gsub!(/\s+(02:57)/, " two fifty seven ")
    foo.gsub!(/\s+(02:56)/, " two fifty six ")
    foo.gsub!(/\s+(02:55)/, " two fifty five ")
    foo.gsub!(/\s+(02:54)/, " two fifty four ")
    foo.gsub!(/\s+(02:53)/, " two fifty three ")
    foo.gsub!(/\s+(02:52)/, " two fifty two ")
    foo.gsub!(/\s+(02:51)/, " two fifty one ")
    foo.gsub!(/\s+(02:50)/, " two fifty ")
    foo.gsub!(/\s+(02:49)/, " two forty nine ")
    foo.gsub!(/\s+(02:48)/, " two forty eight ")
    foo.gsub!(/\s+(02:47)/, " two forty seven ")
    foo.gsub!(/\s+(02:46)/, " two forty six ")
    foo.gsub!(/\s+(02:45)/, " two forty five ")
    foo.gsub!(/\s+(02:44)/, " two forty four ")
    foo.gsub!(/\s+(02:43)/, " two forty three ")
    foo.gsub!(/\s+(02:42)/, " two forty two ")
    foo.gsub!(/\s+(02:41)/, " two forty one ")
    foo.gsub!(/\s+(02:40)/, " two forty ")
    foo.gsub!(/\s+(02:39)/, " two thirty nine ")
    foo.gsub!(/\s+(02:38)/, " two thirty eight ")
    foo.gsub!(/\s+(02:37)/, " two thirty seven ")
    foo.gsub!(/\s+(02:36)/, " two thirty six ")
    foo.gsub!(/\s+(02:35)/, " two thirty five ")
    foo.gsub!(/\s+(02:34)/, " two thirty four ")
    foo.gsub!(/\s+(02:33)/, " two thirty three ")
    foo.gsub!(/\s+(02:32)/, " two thirty two ")
    foo.gsub!(/\s+(02:31)/, " two thirty one ")
    foo.gsub!(/\s+(02:30)/, " two thirty ")
    foo.gsub!(/\s+(02:29)/, " two twenty nine ")
    foo.gsub!(/\s+(02:28)/, " two twenty eight ")
    foo.gsub!(/\s+(02:27)/, " two twenty seven ")
    foo.gsub!(/\s+(02:26)/, " two twenty six ")
    foo.gsub!(/\s+(02:25)/, " two twenty five ")
    foo.gsub!(/\s+(02:24)/, " two twenty four ")
    foo.gsub!(/\s+(02:23)/, " two twenty three ")
    foo.gsub!(/\s+(02:22)/, " two twenty two ")
    foo.gsub!(/\s+(02:21)/, " two twenty one ")
    foo.gsub!(/\s+(02:20)/, " two twenty ")
    foo.gsub!(/\s+(02:19)/, " two nineteen ")
    foo.gsub!(/\s+(02:18)/, " two eighteen ")
    foo.gsub!(/\s+(02:17)/, " two seventeen ")
    foo.gsub!(/\s+(02:16)/, " two sixteen ")
    foo.gsub!(/\s+(02:15)/, " two fifteen ")
    foo.gsub!(/\s+(02:14)/, " two fourteen ")
    foo.gsub!(/\s+(02:13)/, " two thirteen ")
    foo.gsub!(/\s+(02:12)/, " two twelve ")
    foo.gsub!(/\s+(02:11)/, " two eleven ")
    foo.gsub!(/\s+(02:14)/, " two fourteen ")
    foo.gsub!(/\s+(02:13)/, " two thirteen ")
    foo.gsub!(/\s+(02:12)/, " two twelve ")
    foo.gsub!(/\s+(02:11)/, " two eleven ")
    foo.gsub!(/\s+(02:10)/, " two ten ")
    foo.gsub!(/\s+(02:09)/, " two o nine ")
    foo.gsub!(/\s+(02:08)/, " two o eight ")
    foo.gsub!(/\s+(02:07)/, " two o seven ")
    foo.gsub!(/\s+(02:06)/, " two o six ")
    foo.gsub!(/\s+(02:05)/, " two o five ")
    foo.gsub!(/\s+(02:04)/, " two o four ")
    foo.gsub!(/\s+(02:03)/, " two o three ")
    foo.gsub!(/\s+(02:02)/, " two o two ")
    foo.gsub!(/\s+(02:01)/, " two o one ")
    foo.gsub!(/\s+(02:00)/, " two ")
    foo.gsub!(/\s+(01:50)/, " one fifty ")
    foo.gsub!(/\s+(01:49)/, " one forty nine ")
    foo.gsub!(/\s+(01:48)/, " one forty eight ")
    foo.gsub!(/\s+(01:47)/, " one forty seven ")
    foo.gsub!(/\s+(01:46)/, " one forty six ")
    foo.gsub!(/\s+(01:45)/, " one forty five ")
    foo.gsub!(/\s+(01:44)/, " one forty four ")
    foo.gsub!(/\s+(01:43)/, " one forty three ")
    foo.gsub!(/\s+(01:42)/, " one forty two ")
    foo.gsub!(/\s+(01:41)/, " one forty one ")
    foo.gsub!(/\s+(01:40)/, " one forty ")
    foo.gsub!(/\s+(01:39)/, " one thirty nine ")
    foo.gsub!(/\s+(01:38)/, " one thirty eight ")
    foo.gsub!(/\s+(01:37)/, " one thirty seven ")
    foo.gsub!(/\s+(01:36)/, " one thirty six ")
    foo.gsub!(/\s+(01:35)/, " one thirty five ")
    foo.gsub!(/\s+(01:34)/, " one thirty four ")
    foo.gsub!(/\s+(01:33)/, " one thirty three ")
    foo.gsub!(/\s+(01:32)/, " one thirty two ")
    foo.gsub!(/\s+(01:31)/, " one thirty one ")
    foo.gsub!(/\s+(01:30)/, " one thirty ")
    foo.gsub!(/\s+(01:29)/, " one twenty nine ")
    foo.gsub!(/\s+(01:28)/, " one twenty eight ")
    foo.gsub!(/\s+(01:27)/, " one twenty seven ")
    foo.gsub!(/\s+(01:26)/, " one twenty six ")
    foo.gsub!(/\s+(01:25)/, " one twenty five ")
    foo.gsub!(/\s+(01:24)/, " one twenty four ")
    foo.gsub!(/\s+(01:23)/, " one twenty three ")
    foo.gsub!(/\s+(01:22)/, " one twenty two ")
    foo.gsub!(/\s+(01:21)/, " one twenty one ")
    foo.gsub!(/\s+(01:20)/, " one twenty ")
    foo.gsub!(/\s+(01:19)/, " one nineteen ")
    foo.gsub!(/\s+(01:18)/, " one eighteen ")
    foo.gsub!(/\s+(01:17)/, " one seventeen ")
    foo.gsub!(/\s+(01:16)/, " one sixteen ")
    foo.gsub!(/\s+(01:15)/, " one fifteen ")
    foo.gsub!(/\s+(01:14)/, " one fourteen ")
    foo.gsub!(/\s+(01:13)/, " one thirteen ")
    foo.gsub!(/\s+(01:12)/, " one twelve ")
    foo.gsub!(/\s+(01:11)/, " one eleven ")
    foo.gsub!(/\s+(01:14)/, " one fourteen ")
    foo.gsub!(/\s+(01:13)/, " one thirteen ")
    foo.gsub!(/\s+(01:12)/, " one twelve ")
    foo.gsub!(/\s+(01:11)/, " one eleven ")
    foo.gsub!(/\s+(01:10)/, " one ten ")
    foo.gsub!(/\s+(01:09)/, " one o nine ")
    foo.gsub!(/\s+(01:08)/, " one o eight ")
    foo.gsub!(/\s+(01:07)/, " one o seven ")
    foo.gsub!(/\s+(01:06)/, " one o six ")
    foo.gsub!(/\s+(01:05)/, " one o five ")
    foo.gsub!(/\s+(01:04)/, " one o four ")
    foo.gsub!(/\s+(01:03)/, " one o three ")
    foo.gsub!(/\s+(01:02)/, " one o two ")
    foo.gsub!(/\s+(01:01)/, " one o one ")
    foo.gsub!(/\s+(01:00)/, " one ")
