...
$(document).ready(  function() {
    $('.new_entry_sequence form input#sequencetext').bind(
      'focusin',function(event) {    
        if (this.value === "Enter Data, then tab out")                      {   $('.new_entry_sequence form input#sequencetext').val("Please Enter Your Data, then tab out");     }
        else if (this.value === "Please Enter Your Data, then tab out")     {   $('.new_entry_sequence form input#sequencetext').val("Enter Your Data, then tab out");     }
        else                                                                {   $('.new_entry_sequence form input#sequencetext').focus();    } 
      })
        .bind(
          ...
          {
            $("#spinner").activity(false);         
            $('input#sequencetext').val("Please Enter Your Data, then tab on out");
