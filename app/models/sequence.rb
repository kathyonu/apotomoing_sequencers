class Sequence < ActiveRecord::Base
  ...
  attr_accessible :sequence_text, :sequence_creation, :sequence_complete, :sequence_lexigram, :sequence_singular, :sequence_lense, :description, :reference, :anagram, :name, :phrase, :research, :external, :internal
 #attr_accessible :singular_sequences, :lexigram_sequences
   
# taken out of sequences controller as a group, and the gig still works
# we have the methods in the /lib/individual-sequence-search.rb file. text.rb, complete.rb etc.
