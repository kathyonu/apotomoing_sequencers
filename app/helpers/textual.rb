...
#   foo.gsub(/[Á]/, "c")                 # foreign character replacement
    ...
    foo.gsub!(/\s13[\''],?\s?1[\""]\s/, " thirteen feet one inches ")
    ...
    foo.gsub!(/\s12[\''],?\s?1[\""]\s/, " twelve feet one inches ")
    ...
    foo.gsub!(/\s11[\''],?\s?1[\""]\s/, " eleven feet one inches ")
    ...
    foo.gsub!(/\s10[\''],?\s?1[\""]\s/, " ten feet one inches ")
    ...
    foo.gsub!(/\s9[\''],?\s?1[\""]\s/, " nine feet one inches ")
    ...
    foo.gsub!(/\s8[\''],?\s?1[\""]\s/, " eight feet one inches ")
    ...
    foo.gsub!(/\s7[\''],?\s?1[\""]\s/, " seven feet one inches ")
    ...
    foo.gsub!(/\s6[\''],?\s?1[\""]\s/, " six feet one inches ")
    ...
    foo.gsub!(/\s5[\''],?\s?1[\""]\s/, " five feet one inches ")
    ...
    foo.gsub!(/\s4[\''],?\s?1[\""]\s/, " four feet one inches ")
    ...
    foo.gsub!(/\s3[\''],?\s?1[\""]\s/, " three feet one inches ")
    ...
    foo.gsub!(/\s2[\''],?\s?1[\""]\s/, " two feet one inches ")
    ...
    foo.gsub!(/\s1[\''],?\s?1[\""]\s/, " one foot one inches ")
    ...
    foo.gsub!(/\s1\s?ft\.\s/, " one foot ")
    foo.gsub!(/\s1\s?ft\,\s/, " one foot, ")
    foo.gsub!(/(\B(ft.?)\s)/, " feet ")               # ft. preceeded by a non-word boundary, with or without the period, 300ft becomes 300 feet
    foo.gsub!(/(\B(ft.?)$)/, " feet")                # ft. at the end of the line, preceeded by a non-word boundary, ft. becomes feet
   ...
   #foo.gsub!(/(\s(1000(['']?)s)\s+?)/, " thousands ")       # with all the ' still existing
    ...
    foo.gsub!(/^3\.?\s/, " three, ")
    foo.gsub!(/^2\.?\s/, " two, ")
    foo.gsub!(/^1\.?\s/, " one, ")            # somehow, this is being processed before the yards and yard group far above # TODOresearch why
    foo.gsub!(/^0\.?\s/, " zero, ")
    foo.gsub!(/9/, " nine ")
    foo.gsub!(/8/, " eight ")
    foo.gsub!(/7/, " seven ")
