...
$j(document).ready( function() {    $j('#anagram form input#submit').hide();  });
...
$j(document).ready(
  $j('.new_entry_sequence form input#sequence_submit').bind(
   'submit',function(event) {
    ...
    $jsubmit.form.onsubmit = function() { return false; };
            ...
            if (this.value !== '') {
              if (this.value !== "Enter data, then tab out") {
                if (this.value !== "Please Enter Your Data") {
                  $j('.thecounts').hide();
                  $j('input#sequencetext').blur();
$j("#spinner").activity({outside: true, align: 'left', segments: 1});
                  ...
                  $j("#spinner").activity(false);         
                  $j("input#sequence_sequence_text").val($jtext_return_value);
$j("#spinner").activity({outside: true, align: 'left', segments: 2});
...
$j("#spinner").activity({outside: true, align: 'left', segments: 3});
...
$j("#spinner").activity({outside: true, align: 'left', segments: 4});
...
$j("#spinner").activity({outside: true, align: 'left', segments: 5});
...
$j("#spinner").activity({outside: true, align: 'left', segments: 4});
                    var $jsingularscount = $j.ajax({
                      type: "GET", url: "http://localhost:3000/sequences/singulars_count", data: $jsequencetext, async: false, dataType: 'script', success: function(data) {
                      } }).responseText;
...
$j("#spinner").activity({outside: true, align: 'left', segments: 4});
                    var $jlexigramscount = 0
                    var $jcompletescount = 0
                    var $jcreationscount = 0
                    var $jtextscount = 0
                    $jsingularcount = "s - " + $jsingularscount
...
$j("#spinner").activity({outside: true, align: 'left', segments: 6});
                  if (textsequencesing !== "") {
          ...
          else
          {
            ...
            $j('#countlexigrams').hide();
            $j('#countcompletes').hide();
            $j('#countcreations').hide();
            $j('#counttexts').hide();
          }
    });
  });
        ...
        'focusout',function(event) {
          if (this.value !== '') {
            if (this.value !== "Enter data, then tab out") {
              ...
              var $jsequenceSubmit = document.getElementById('sequence_submit');
              $jnewsequence.form.onsubmit = function() { return false; };
              var $jsearch_text_return_value = $j.ajax({     type: "GET",    url: "http://localhost:3000/sequences/search_text",        data: $jsequencetext,    async: false,    dataType: 'script',    success: function(data) {    alert(data);    }    }).responseText;
              $j("#search_text").val($jsearch_text_return_value);
              var $jsearch_creation_return_value = $j.ajax({ type: "GET",    url: "http://localhost:3000/sequences/search_creation",    data: $jsequencetext,    async: false,    dataType: 'script',    success: function(data) {    alert(data);    }    }).responseText;
              $j("#search_creation").val($jsearch_creation_return_value);
              var $jsearch_complete_return_value = $j.ajax({ type: "GET",    url: "http://localhost:3000/sequences/search_complete",    data: $jsequencetext,    async: false,    dataType: 'script',    success: function(data) {    alert(data);    }    }).responseText;
              $j("#search_complete").val($jsearch_complete_return_value);
              var $jsearch_lexi_return_value = $j.ajax({     type: "GET",    url: "http://localhost:3000/sequences/search_lexigram",    data: $jsequencetext,    async: false,    dataType: 'script',    success: function(data) {    alert(data);    }    }).responseText;
              $j("#search_lexigram").val($jsearch_lexi_return_value);
              var $jsearch_singular_return_value = $j.ajax({ type: "GET",    url: "http://localhost:3000/sequences/search_singular",    data: $jsequencetext,    async: false,    dataType: 'script',    success: function(data) {    alert(data);    }    }).responseText;
